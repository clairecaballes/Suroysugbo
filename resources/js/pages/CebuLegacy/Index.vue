    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="mb-4">
            <button
                ...
                @click="$inertia.visit('/cebu-legacy/edit')"
            >New</button>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-xs text-left text-gray-700 border border-gray-200 rounded-lg">
                ...
                <tbody>
                    <tr v-for="(item, index) in legacyItems" :key="item.id"
                     class="border-t hover:bg-gray-50" >
                        ...
                        <td class="px-3 py-2">
                            <button
                                ...
                                @click.prevent="$inertia.visit(`/cebu-legacy/edit/${item.id}`)"
                            >Edit</button>
                            &nbsp;
                               <button
                                class="text-red-600 hover:underline"
                                @click.prevent="onDelte(item)"
                            >Delete</button>
                        </td>
                    </tr>
                </tbody>
